...
class AuthControllerTest {
    ...
    void register_BadRequest() throws Exception {
        when(authService.register(any(User.class))).thenThrow(new RuntimeException("Error register"));
    ...
    void login_Success() throws Exception {
        when(authService.login("12345678A", "pass")).thenReturn(testUser);
    ...
    void login_Unauthorized() throws Exception {
        when(authService.login(anyString(), anyString())).thenThrow(new RuntimeException("Bad credentials"));
    ...
    void updateProfile_Success() throws Exception {
        when(authService.updateProfile(eq(1L), anyString(), anyString())).thenReturn(testUser);
    ...
    void updateProfile_Error() throws Exception {
        when(authService.updateProfile(eq(1L), anyString(), anyString())).thenThrow(new RuntimeException("Update failed"));
