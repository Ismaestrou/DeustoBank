...
class AccountControllerTest {
    ...
    // Beans extra requeridos por el contexto de Spring
    @MockBean
    ...
    // ============================================================
    // getTransactions – sin filtro de fechas (camino happy)
    // ============================================================
    ...
    // ============================================================
    // getTransactions – con filtro de fechas (rama from/to)
    // ============================================================
    ...
    // ============================================================
    // getTransactions – requester no autorizado (rama 403)
    // ============================================================
    ...
    void deposit_Success() throws Exception {
        ...
        when(service.deposit(10L, 500.0, 1L)).thenReturn(testAccount);
    ...
    void deposit_Error() throws Exception {
        ...
        when(service.deposit(10L, 500.0, 1L))
    ...
    void withdraw_Success() throws Exception {
        ...
        when(service.withdraw(10L, 200.0, 1L)).thenReturn(response);
    ...
    // ============================================================
    // withdraw – excepción (saldo insuficiente, etc.)
    // ============================================================

    @Test
    void withdraw_Error() throws Exception {

        when(service.withdraw(10L, 9999.0, 1L))
    ...
    // ============================================================
    // transfer – éxito con alerta (rama alerta != null)
    // ============================================================
    ...
    // ============================================================
    // getPdfStatement – no autorizado (rama 403)
    // ============================================================
